...
export function handleSummary(data) {
  return {
    'standard-endpoint-results.html': htmlReport(data),
    'standard-endpoint-results.json': JSON.stringify(data),
  };
}
...
<html>
<head>
    <title>Standard Endpoint - Load Test Results</title>
    <style>
...
<body>
    <h1>Standard Endpoint Load Test Results</h1>
    <div class="metric">
        <h3>Request Rate</h3>
